...
public class AudioService : IAudioService
{
    ...
    public void OnPlaySoundAtPosition(Vector3 position, string audioPath) => PlaySoundAtPositionEvent?.Invoke(this, new PlaySoundAtPositionEventArgs(position, audioPath));
